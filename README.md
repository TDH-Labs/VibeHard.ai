...
**Working name** (placeholder): *Drydock* — where a vessel is inspected and made
...
bun run src/cli.ts  # the drydock CLI (stub today)
```
...
and rules verbatim. **Done when** `drydock gate ~/dev/gate-proof/app` reproduces
